...
import { MessageCircle, MessageSquare, Phone, Mail, Send, CheckCircle, AlertCircle, Loader2, Globe, Shield, Clock, Award, Users, Star } from "lucide-react"
...
export default function ProKiteContactPage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const element = document.getElementById('prokite-contact-form')
      if (element) {
  ...
  const handleContactSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    Object.keys(formData).forEach(key => {
      if (key !== 'honeypot' && key !== 'courseType' && key !== 'experienceLevel') {
    ...
    try {
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          subject: `ProKite Sardegna Course Inquiry - ${formData.courseType}`,
          message: `Course Type: ${formData.courseType}\nExperience Level: ${formData.experienceLevel}\n\nMessage: ${formData.message}`,
          destination: 'sardinia',
          source: 'prokite-contact-page',
      ...
      if (result.success) {
        ...
        setSubmitMessage("Thank you for your interest in ProKite courses! Our team will get back to you within 24 hours with course details, pricing, and availability.")
        // Reset form
        setFormData({
          name: '',
          email: '',
      ...
      console.error("[v0] ProKite contact form submission error:", error)
      setSubmitStatus('error')
  ...
  const handleWhatsApp = () => {
    const message = "Hi! I'd like to inquire about ProKite Sardegna kitesurfing courses."
    const whatsappUrl = `https://wa.me/393280026778?text=${encodeURIComponent(message)}`
  ...
  const handlePhone = () => {
    window.location.href = "tel:+393280026778"
  }

  const handleEmail = () => {
    const subject = "ProKite Sardegna Course Inquiry"
    const body = "Hi, I'm interested in learning more about your kitesurfing courses at Punta Trettu."
    const mailtoUrl = `mailto:info@prokitesardegna.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`
    window.location.href = mailtoUrl
  }

  const courseTypes = [
    { value: 'zero-to-hero', label: 'Zero to Hero (10h) - €550', description: 'Complete beginner program with photography' },
    { value: 'training-full-focus', label: 'Training Full Focus (2h) - €160', description: 'Advanced sessions with video analysis' },
    { value: 'beginner', label: 'Beginner Programs (1-6h)', description: 'From €80 - Introductory to comprehensive courses' },
    { value: 'children', label: 'Children\'s Instruction', description: 'Specialized programs for young kitesurfers' },
    { value: 'wing-foil', label: 'Wing Foil Training', description: 'Cutting-edge instruction in newest discipline' },
    { value: 'hydrofoil', label: 'Hydrofoil & Strapless', description: 'Advanced specialization courses' }
  ]
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <h1 className="font-montserrat text-4xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg">
              ProKite Sardegna Courses
            </h1>
            <p className="font-open-sans text-xl text-white/90 max-w-3xl mx-auto drop-shadow-md">
              Learn from Italy's premier kitesurfing school at Punta Trettu. IKO certified instruction with world-class facilities and perfect learning conditions.
            </p>
          </div>
        </div>
      </section>

      {/* ProKite Credentials Section */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-montserrat text-3xl font-bold text-deep-navy mb-4">Why Choose ProKite Sardegna?</h2>
            <p className="font-open-sans text-lg text-gray-600 max-w-2xl mx-auto">
              Experience world-class kitesurfing instruction with Italy's most prestigious school
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-montserrat font-bold text-deep-navy mb-2">5.0 Star Rating</h3>
              <p className="font-open-sans text-gray-600 text-sm">543+ Google reviews</p>
            </div>
            <div className="text-center">
              ...
              <p className="font-open-sans text-gray-600 text-sm">Professional instructors</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="font-montserrat font-bold text-deep-navy mb-2">Multi-language</h3>
              <p className="font-open-sans text-gray-600 text-sm">6 languages supported</p>
            </div>
            <div className="text-center">
              <div className="bg-deep-navy-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Shield className="w-8 h-8 text-deep-navy" />
              </div>
              <h3 className="font-montserrat font-bold text-deep-navy mb-2">Safety First</h3>
              <p className="font-open-sans text-gray-600 text-sm">Radio helmets & rescue boat</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* ProKite Course Inquiry Form */}
            <div 
              id="prokite-contact-form"
                ...
                <div className="relative z-10">
                  <div className="text-center mb-8">
                    ...
                    <p className="font-open-sans text-gray-600 mb-4">
                      Get personalized course recommendations and pricing. We reply within 24 hours.
                    </p>
                    
                    {/* Social Proof */}
                    <div className="flex items-center justify-center space-x-2 text-sm text-gray-500">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span>Over 500 students have learned with ProKite!</span>
                    </div>
                  </div>
                  ...
                  <form ref={formRef} onSubmit={handleContactSubmit} className="space-y-6">
                    ...
                    <div className="relative">
                      <label htmlFor="courseType" className="block font-montserrat font-semibold text-deep-navy mb-2">
                        Course Interest
                      </label>
                      <div className="relative">
                        <select
                      ...
                      <p className="mt-2 text-sm text-gray-600">
                        {courseTypes.find(c => c.value === formData.courseType)?.description}
                      </p>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="relative">
                        <textarea
                          ...
                          placeholder="Tell us about your kitesurfing goals, preferred dates, group size, or any specific questions about the courses..."
                    ...
                    <button
                      ...
                      aria-label="Send course inquiry"
                    >
                      {isSubmitting ? (
            ...
            {/* ProKite Contact Information & Quick Actions */}
            <div className="space-y-8">
              <div>
                <h2 className="font-montserrat text-2xl font-bold text-deep-navy mb-6">ProKite Sardegna Contact</h2>
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="font-open-sans text-gray-700">+39 328 002 6778</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-turquoise rounded-full p-3 mr-4">
                    ...
                    <div>
                      ...
                      <p className="font-open-sans text-gray-700">info@prokitesardegna.com</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-turquoise rounded-full p-3 mr-4">
              ...
              <div className="bg-gradient-to-br from-deep-navy to-turquoise rounded-2xl p-8 text-white shadow-2xl">
                ...
                <p className="font-open-sans mb-6">
                  For urgent course inquiries, use our instant channels below.
                </p>
                ...
                <div className="space-y-4">
                  <button 
                    ...
                    aria-label="Contact ProKite on WhatsApp"
                    role="button"
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="font-open-sans text-sm text-white/90">Instant course support</div>
                    </div>
                  </button>
                  ...
                  <button 
                    ...
                    className="w-full bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/20 hover:border-white/30 transition-all duration-200 rounded-lg p-4 flex items-center group hover:scale-105"
                    aria-label="Start live chat with ProKite team"
                    role="button"
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className="font-open-sans text-sm text-white/90">Chat with ProKite team</div>
                    </div>
                  </button>
                  ...
                  <button 
                    onClick={handlePhone} 
                    className="w-full bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/20 hover:border-white/30 transition-all duration-200 rounded-lg p-4 flex items-center group hover:scale-105"
                    aria-label="Call ProKite directly"
                    role="button"
                  >
                    <Phone className="h-6 w-6 mr-3 text-white group-hover:scale-110 transition-transform" />
                    <div className="text-left">
                      <div className="font-montserrat font-bold text-white">Call ProKite</div>
                  ...
                  <button 
                    onClick={handleEmail} 
                    className="w-full bg-white/20 hover:bg-white/30 backdrop-blur-sm border border-white/20 hover:border-white/30 transition-all duration-200 rounded-lg p-4 flex items-center group hover:scale-105"
                    aria-label="Send ProKite an email"
                    role="button"
                  >
                    <Mail className="h-6 w-6 mr-3 text-white group-hover:scale-110 transition-transform" />
                    <div className="text-left">
                      <div className="font-montserrat font-bold text-white">Email ProKite</div>
                      <div className="font-open-sans text-sm text-white/90">Course information</div>
                    </div>
                  </button>
                </div>
              </div>
              ...
              {/* Course Information */}
              <div>
                <h3 className="font-montserrat text-xl font-bold text-deep-navy mb-4">Course Information</h3>
                <div className="space-y-3 font-open-sans text-gray-700">
                  ...
                  <div className="flex justify-between">
                    <span>Equipment</span>
                    <span>Premium Duotone</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Safety</span>
                    <span>Radio helmets</span>
                  </div>
                </div>
                <p className="font-open-sans text-sm text-gray-600 mt-4">
                  * All courses include professional rescue boat service
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-montserrat text-3xl font-bold text-deep-navy mb-4">Punta Trettu Location</h2>
            <p className="font-open-sans text-lg text-gray-600 max-w-2xl mx-auto">
              Perfect learning conditions with shallow waters, sandy bottom, and consistent thermal winds
            </p>
          </div>
          <div className="grid grid-cols-1 gap-8">
            <DestinationFocusedMap
              destination={{
                id: "sardinia",
                name: "ProKite Sardegna - Punta Trettu",
